...
import ScoreLine from '@/components/ScoreLine/ScoreLine.vue';
  ...
  <div class="bg">
    ...
    <section class="profile-stats">
      <div class="container">
        ...
        <div class="profile__stats-wrapper">
          ...
          <div class="profile-community-info">
            <div>
              <p>
                {{ $t('profile.details.joined') }} <span>19 January 2020</span>
              </p>
              <p>
                {{ $t('profile.details.plays_with') }}
                <span>Keyboard, Tablet</span>
              </p>
            </div>
            <p class="subscribers">
              300 {{ $t('profile.details.subscribers') }}
            </p>
          </div>
          <ul class="profile-links">
            <li class="profile-link">
              <i class="website"></i
              ><RouterLink class="text" to="/"
                >www.twitch.tv/Bubbleman</RouterLink
              >
            </li>
            <li class="profile-link">
              <i class="lives"></i>
              <p class="text">Somewhere in Wales</p>
            </li>
            <li class="profile-link">
              <i class="occupation"></i>
              <p class="text">Software Developer</p>
            </li>
            <li class="profile-link">
              <i class="interests"></i>
              <p class="text">Enjoying my time</p>
            </li>
            <li class="profile-link">
              <i class="twitter"></i
              ><RouterLink class="text" to="/">@magn3ta_</RouterLink>
            </li>
            <li class="profile-link">
              <i class="discord"></i
              ><RouterLink class="text" to="/">magn3ta#1231</RouterLink>
            </li>
          </ul>
        </div>
      </div>
          ...
          <div class="profile-block__title">
            <div>
              <h3 class="about-me__title">
                {{ $t('profile.about.about_me') }}
              </h3>
              <RouterLink to="/" class="about-me__edit">{{
                $t('profile.about.edit')
              }}</RouterLink>
            </div>
            <span>{{ $t('profile.about.bio') }}</span>
          </div>
          <div class="profile-block__content">
            <div class="about-me__textarea"></div>
          </div>
        </div>
      </section>
      <section class="activity-bg">
        <div class="container">
          <div class="profile-block__title">
            <h3>{{ $t('profile.activity.recent') }}</h3>
            <span>{{ $t('profile.activity.user_activity') }}</span>
          </div>
          <div class="profile-block__content activity-wrapper">
            <ScoreLine></ScoreLine>
            <ShowMoreButton />
          </div>
        </div>
...
.profile-links {
  ...
  .profile-link {
    ...
    .website {
      background: url('@/assets/svg/profile-website.svg');
    }

    .lives {
      background: url('@/assets/svg/profile-map.svg');
    }

    .occupation {
      background: url('@/assets/svg/profile-occupation.svg');
    }

    .interests {
      background: url('@/assets/svg/profile-interests.svg');
    }

    .twitter {
      background: url('@/assets/svg/profile-twitter.svg');
    }

    .discord {
      background: url('@/assets/svg/profile-discord.svg');
    }
  }
}
