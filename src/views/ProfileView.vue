...
const userAvatar = userStore.isLoggedIn
  ? `url('https://a.${import.meta.env.VITE_APP_DOMAIN}/${userStore.user.id}')`
  : `url('https://a.${import.meta.env.VITE_APP_DOMAIN}/default.jpg')`;

const isFriend = ref(false);
const isOnline = ref(false);
const isSupporter = ref(false);
const activeGamemode = ref(1);
const activeMod = ref(1); // Vanilla, Relax, Autopilot
const levelBar = ref(40);
      ...
      <div class="container">
        <div class="main__cover">
          <div class="main__info">
            <!-- <img class="main__avatar" :src="userAvatar" alt="avatar" /> -->
        ...
        <div class="modes-wrapper">
          <div class="modes">
            ...
            <button
              ...
              :class="{ 'active-gamemode': activeGamemode === 4 }"
            >
              <i></i>
              osu!mania
            </button>
            ...
            <div class="profile__details">
              <div>
                <dl class="detail__entry">
                  ...
                  <dd class="detail__value">22,141pp</dd>
                </dl>
                <dl class="detail__entry">
                  <dt class="detail__key">
                    {{ $t('profile.details.accuracy') }}
                  </dt>
                  <dd class="detail__value">99.35%</dd>
                </dl>
                <dl class="detail__entry">
                  <dt class="detail__key">
                    {{ $t('profile.details.ranked_score') }}
                  </dt>
                  <dd class="detail__value">1,947,566,190</dd>
                </dl>
                <dl class="detail__entry">
                  <dt class="detail__key">
                    {{ $t('profile.details.total_score') }}
                  </dt>
                  <dd class="detail__value">22,917,545,636</dd>
                </dl>
                <dl class="detail__entry">
                  <dt class="detail__key">
                    {{ $t('profile.details.max_combo') }}
                  </dt>
                  <dd class="detail__value">22,343</dd>
                </dl>
              </div>
              <div>
                <dl class="detail__entry">
                  ...
                  <dd class="detail__value">199,244</dd>
                </dl>
                <dl class="detail__entry">
                  <dt class="detail__key">
                    {{ $t('profile.details.first_places') }}
                  </dt>
                  <dd class="detail__value">13,834</dd>
                </dl>
                <dl class="detail__entry">
                  <dt class="detail__key">
                    {{ $t('profile.details.watched_replays') }}
                  </dt>
                  <dd class="detail__value">8,413,834</dd>
                </dl>
                <dl class="detail__entry">
                  <dt class="detail__key">
                    {{ $t('profile.details.playtime') }}
                  </dt>
                  <dd class="detail__value">144d 15h 11m</dd>
                </dl>
              </div>
            </div>
            <div class="profile__level-wrapper">
              <span class="progress-bar" :style="`width: ${levelBar}%;`"></span>
              <span class="level">{{ $t('profile.details.level') }} 102</span>
            </div>
          </div>
        </div>
      </div>
